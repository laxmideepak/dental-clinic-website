        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 hover:shadow-xl transition-shadow duration-300">
            <div className="flex items-start mb-6">
              <div className="bg-jefferson-pink rounded-full p-4 mr-4 flex-shrink-0">
            ...
            <div className="mb-6">
              ...
              <ul className="space-y-2 text-gray-700">
                <li className="flex items-center">
                  <Check className="w-5 h-5 text-jefferson-blue mr-3" />
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 hover:shadow-xl transition-shadow duration-300">
            <div className="flex items-start mb-6">
              <div className="bg-jefferson-lime rounded-full p-4 mr-4 flex-shrink-0">
                <svg viewBox="0 0 24 24" className="w-6 h-6 text-white fill-current">
            ...
            <div className="mb-6">
              ...
              <ul className="space-y-2 text-gray-700">
                <li className="flex items-center">
                  <Check className="w-5 h-5 text-jefferson-lime mr-3" />
